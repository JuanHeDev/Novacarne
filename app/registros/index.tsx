    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.centerWrapper}>
        <View style={[styles.card, { backgroundColor: colors.card, width: cardWidth }]}>
          <Text style={[styles.cardTitle, { color: colors.text, fontSize: titleSize }]}>Registros</Text>
          <TouchableOpacity style={[styles.optionButton, { borderColor: colors.accent }]} onPress={() => router.push('/registros/perfil')}>
            <MaterialCommunityIcons name="account-circle" size={buttonIconSize} color={colors.accent} />
            <Text style={[styles.optionText, { color: colors.text }]}>Perfil</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.optionButton, { borderColor: colors.accent }]} onPress={() => router.push('/registros/sucursal')}>
            <MaterialCommunityIcons name="store" size={buttonIconSize} color={colors.accent} />
            <Text style={[styles.optionText, { color: colors.text }]}>Sucursal</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.optionButton, { borderColor: colors.accent }]} onPress={() => router.push('/registros/producto')}>
